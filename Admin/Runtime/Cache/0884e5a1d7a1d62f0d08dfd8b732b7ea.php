...
<div id="contentWrap">
  ...
  <div id="widget table-widget">
    ...
    <div class="pageColumn">
      <div class="pageButton" style="color: red; font-size: 32">这个是关于我们的介绍</div>
     <form action="__URL__/updateall" method="post">
      <table>
        <input type="hidden" name="new"  value="1"/>
        <tr><td><textarea id="body" name="body" style="width:900px; height:400px;"><?php echo ($new["body"]); ?></textarea></td></tr>
