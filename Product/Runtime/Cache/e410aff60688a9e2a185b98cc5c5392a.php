...
<body onload="showHint()">
	<div class="AllWrap headerInfo">
		...
		<div class="qbspfl" style="top: 225px;">
			<a href="#">全部商品分类</a>
		</div>
  ...
  <div class="qingzdy"></div>
		<div class="logo">
			<a href="./"><img src="__PUBLIC__/themes/buy2012/images/loge.png"
				border="0" /></a>
		</div>
		<div class="searchbar">
      ...
      <table cellpadding="0" cellspacing="0">
		...
		<div class="searchbarr">
			热门搜索：<a href="http://www.qizejx.cn/?gallery-9-grid.html">手拉葫芦</a><a
				href="http://www.qizejx.cn/?gallery-40-grid.html">液压千斤顶</a><a
				href="http://www.qizejx.cn/?gallery-11-b,29-0--1--grid.html">电动葫芦</a><a
				href="http://www.qizejx.cn/?gallery-24-grid.html">龙门吊架</a>
		</div>
		<div
			style="color: #EEEFF1; left: 680px; position: absolute; top: 80px;">
			<img src="__PUBLIC__/themes/buy2012/images/dianhua.png" />
		</div>
		<div
			style="color: #EEEFF1; left: 200px; position: absolute; top: 160px;">
			<img src="__PUBLIC__/themes/buy2012/images/kouhao.png" />
		</div>
      ...
      <li><a href="#">客户留言</a></li>
				<li style="position: relative; z-index: 65535;"
					...
					<div class="v-m-page"
						...
						<div>
							<a
								href="http://www.qizejx.cn/?page-%E8%B5%84%E8%B4%A8%E8%AF%81%E4%B9%A6.html">资质证书</a>
						</div>
						<div>
							<a
								href="http://www.qizejx.cn/?page-%E7%BD%91%E7%BB%9C%E8%90%A5%E9%94%80.html">网络营销</a>
						</div>
						<div>
							<a href="http://www.qizejx.cn/?artlist-119.html">动态新闻</a>
						</div>
						<div>
							<a
								href="http://www.qizejx.cn/?page-%E5%B8%AE%E5%8A%A9%E4%B8%AD%E5%BF%83.html">帮助中心</a>
						</div>
						<div>
							<a href="http://www.qizejx.cn/?link-showList.html">友情链接</a>
						</div>
					</div></li>
			</ul>
			<script>
	...
	$('widgets_89_showMore').setOpacity(.8);
		...
		<div class="loginbar">
			<div class="fr topmenu">
				<a href="/new/about.html">关于我们</a> <a
					href="">支付方式</a>
				<a href="#">帮助中心</a>
			</div>
		</div>
			...
			<div id="outer">
				<ul class="menum ulul">
					<li class="sub lili"
						...
						class="aa" href="./"> <comment></a> </comment> <ins>
							<table class="ttable">
								<tr>
									<td><ul class="ulul">
											<li class="lili">
															...
															<div class="DuceDropNavs">
																<ul>
																	<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["sid"]) == "0"): ?><li class="m-cat-depth-1"><a class="depth-1"
																		href="/Product_<?php echo ($vo["id"]); ?>.html"><em><strong><?php echo ($vo["name"]); ?></strong></em></a>
																						...
																						<table width="460" border="0" cellspacing="0"
																							...
																							<tr>
																								<td width="75" align="right"><a
																									class="m-depth-2"
																									href="/Product_<?php echo ($vo2["id"]); ?>.html"><?php echo ($vo2["name"]); ?></a></td>
																								<td><ul class="m-cat-drop-3">
																										<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i; if(($vo2["id"]) == $vo3["sid"]): ?><a
																											href="/Product_<?php echo ($vo3["id"]); ?>.html"><?php echo ($vo3["name"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
																									</ul></td>
																							</tr>
																						</table>
...
.itemsWrap {
	*display: block;
	...
	overflow: hidden;
                  ...
                  <div class="item" style="width:900px; text-align: left">
                    <table width="100%" border="0" cellspacing="0"
												cellpadding="0">
                      <tr>
                        <td width="100"><div class="goodsImg" 	style="overflow: hidden; text-align: left; vertical-align: middle; width: 100px; height: 100px;"> <a href="/Product_<?php echo ($sss["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><img width="100" height="100" 	src="__PUBLIC__/Uploads/<?php echo ($sss["image2"]); ?>" title="<?php echo ($sss["tname"]); ?>"/></a> </div></td>
                        <td width="800"><div style="width:600px; text-align: left"><span ><?php echo ($sss["intro"]); ?></span></div></td>
                      </tr>
                    </table>
			...
			<div id="qin">
				...
				<div class="GoodsSearchWrap">
					<form method="post"
						action="http://www.qizejx.cn/?search-result.html"
						id='selector-form'>
      ...
      var fixEmpeyPanel = (function(el){
         ...
         if($('selector-form').style.display!='none'){
            $$('#selector-form .division').each(fixEmpeyPanel);
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="items-list " product="1231" id="pdt-1231">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tbody>
								<tr>
									<td class="goodpic" style="width: 160px;" valign="middle">
										<a target="_blank" style="width: 160px; height: 160px;"
										href="/Article/<?php echo ($vo["id"]); ?>.html"> <img src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>"
											alt="<?php echo ($vo["title"]); ?>" width="160px"></a>
									</td>
									<td width="10px;">&nbsp;</td>
									<td class="goodinfo" style="word-break:break-all">
										<h6>
											<a href="/Article/<?php echo ($vo["id"]); ?>.html"
												title="<?php echo ($vo["title"]); ?>" class="entry-title" target="_blank"><?php echo ($vo["title"]); ?></a>
										</h6><span ><?php echo ($vo["intro"]); ?></span> 
										<p>
										<?php if(is_array($vo['shoppar'])): $i = 0; $__LIST__ = $vo['shoppar'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><a href="/Article/<?php echo ($vo["id"]); ?>.html#shop<?php echo ($vo2["id"]); ?>"><?php echo ($vo2["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
										</p>
									</td>
								</tr>
							</tbody>
					...
					<div class="body clearfix">
						<ul>
							...
							<li class="c-cat-depth-1 borderbody">
								<ul>
									<li class="c-cat-depth-1"><?php if(is_array($er)): $i = 0; $__LIST__ = $er;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="margin-top: 4px; width: 100%;">
											<a style="font-size: 12px" href="/Product_<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["name"]); ?></a>
										</div>
										<ul id="cat2_subs_24">
										...
										</ul><?php endforeach; endif; else: echo "" ;endif; ?></li>
								</ul>
							</li>
							</li>
						</ul>
					...
					<input type="hidden" name="goods_num" id="goods_num" value="5">
						<div class="GoodsListWrap">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td><div class="goodsImg"
														style="overflow: hidden; text-align: center; vertical-align: middle; width: 66px; height: 66px;">
														<a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><img
															width="66" height="66"
															src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" title="<?php echo ($vo["title"]); ?>"></a>
													</div></td>
												<td class="goodsDesc"><h6>
														<a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
													</h6>
													<ul>
													</ul></td>
											</tr>
							...
							<div class="more clearfix">
								<a
									href="http://www.qizejx.cn/?gallery-_ANY_-b,_ANY__t,_ANY_-0-grid.html">更多...</a>
							</div>
						</div>
				</div>
			</div>
