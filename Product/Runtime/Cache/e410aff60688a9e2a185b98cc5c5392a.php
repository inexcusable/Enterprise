...
<div class="AllWrapInside clearfix" style="padding-top:0px;">
  <div class="Navigation">您当前的位置： <span><a href="http://www.qizejx.cn/" alt="" title="">首页</a></span> <span>&raquo;</span>
    ...
    <span class="now">起重葫芦系列</span> </div>
...
.itemsWrap{ *display:block; float:left; overflow:hidden; } 
          ...
          <div class="GoodsListWrap">
            <div class="GoodsList">
              <?php if(is_array($shopth)): $i = 0; $__LIST__ = array_slice($shopth,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="itemsWrap " product="1269" style="width:33%;">
                <div class="item">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><div class="goodsImg" style="overflow:hidden;text-align:center;vertical-align: middle;width:100px;height:100px;"><a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><img width="100"height="100" src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" title="<?php echo ($vo["title"]); ?>"></a></div></td>
          ...
          <div class="GoodsList">     
           ...
           <?php if(is_array($shopth)): $i = 0; $__LIST__ = array_slice($shopth,5,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="itemsWrap " product="149" style="width:99%;">
              <div class="item">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><div class="goodsImg" style="overflow:hidden;text-align:center;vertical-align: middle;width:66px;height:66px;"><a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><img width="66"height="66" src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" title="<?php echo ($vo["title"]); ?>"></a></div></td>
                    <td class="goodsDesc"><h6><a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></h6>
                      <ul>
                      </ul></td>
                  </tr>
...
if(!v||!v.length)return;
      ...
      var template = '<div class="clearfix">';
          ...
          template+= '<a href="http://www.qizejx.cn/?product-{goodsId}-index.html" target="_blank" title="{goodsName}" inner_img="{goodsImg}" gid="{goodsId}">';
          template+= '</a>';
          template+= '</div><div class="prepend-2 goodsName">';
          template+= '<div class="view-time">{viewTime}</div>';
          template+='<a href="http://www.qizejx.cn/?product-{goodsId}-index.html" target="_blank" title="{goodsName}">{goodsName}</a></div></div><hr/>';
      ...
      $('box_widgets_101').set('html',html);
      
    $ES('.goodpic',box).each(function(i){
          var imga=$E('a',i);
          var imgsrc=imga.get('inner_img');
          if(!imgsrc){
            imgsrc = "http://www.qizejx.cn/images/default/default_thumbnail_pic.gif";
          }
       ...
       new Asset.image(imgsrc,{onload:function(){
                ...
                var gid = imga.get('gid');
                 new Request.JSON({method:'get',url:"http://www.qizejx.cn/?product-picsJson.html",onComplete:function(data){
        ...
        <div class="textright"> <a class="lnk clearAll" onclick="if(broswerStore){broswerStore.remove('history');$('box_widgets_101').empty()}">清除列表</a> | <a class="lnk viewAll" href="http://www.qizejx.cn/?tools-history.html">查看所有</a><span>&nbsp;&nbsp;</span> </div>
      </div>
    </div>
  </div>
</div>
