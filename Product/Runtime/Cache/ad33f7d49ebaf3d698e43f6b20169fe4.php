...
if($('widgets_89_showMore')){
  ...
  <div class="loginbar">
    <div class="fr topmenu"> <a href="/new/about.html">关于我们</a> <a
					href="">支付方式</a> <a href="#">帮助中心</a> </div>
  </div>
  <div id="menum">
    <div id="outer">
      <ul class="menum ulul">
	...
	*display: block;
                ...
                <div class="itemsWrap "  style="width: 100%;">
                  <div class="item" style="width:900px;">
                    <table width="100%" border="0" cellspacing="0"
												cellpadding="0">
                      <tr>
                        <td width="100"><div class="goodsImg" 	style="overflow: hidden; text-align: center; vertical-align: middle; width: 100px; height: 100px;"> <a href="/Product_<?php echo ($sss["id"]); ?>.html" target="_blank" title="<?php echo ($vo["title"]); ?>"><img	width="100" height="100"						src="__PUBLIC__/Uploads/<?php echo ($sss["image2"]); ?>" alt=<?php echo ($sss["alt"]); ?> title="<?php echo ($sss["alt"]); ?>"></a> </div></td>
    ...
    <div id="qin">
            ...
            <div class="division boxBrown">
              <table>
                <tr>
                  ...
                  <?php if(is_array($er)): $i = 0; $__LIST__ = $er;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?></td>
                </tr>
              </table>
            </div>
             ...
             <div class="division boxBrown" id="selector_contents">
              ...
              <table width="100%">
                <tr>
                  ...
                  <td style="line-height: 22px; white-space: normal; word-break: break-all">
                  <?php if(is_array($use1)): $i = 0; $__LIST__ = $use1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#"><?php echo ($vo["use1"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    </td>
                </tr>
              </table>
            </div>
      ...
      var fixEmpeyPanel = (function(el){
        ...
        <?php if(is_array($er)): $i = 0; $__LIST__ = $er;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="width:780px; height:240px; margin-top:10px;"><h1><?php echo ($vo["name"]); ?></h1><a href="Product_<?php echo ($vo["id"]); ?>.html"><img src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" height="200" width="780" alt="<?php echo ($vo["name"]); ?>" title="<?php echo ($vo["name"]); ?>"/></a></div>
                    ...
                    <tr>
                      <td><div class="goodsImg"
														style="overflow: hidden; text-align: center; vertical-align: middle; width: 66px; height: 66px;"> <a href="#" target="_blank" title="<?php echo ($vo["title"]); ?>"><img
															width="66" height="66"
															src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" alt="<?php echo ($vo["alt"]); ?>" title="<?php echo ($vo["alt"]); ?>"/></a> </div></td>
